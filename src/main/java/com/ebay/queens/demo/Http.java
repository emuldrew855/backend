...
public class Http implements CommandLineRunner {
	...
	public Utilities utilityClass = new Utilities("test","test",
			"EBAY-US","EBAY-UK",  "test", "A21AAEU40OMhVHxkTsHNK9SfMUh75C-6KiYycLLogklKFxG_YKYz5pxDAK3H34A3NYT_y_5XMTJjkf0sjzK4jC1HLykcGMiFg",
